      ...
      <div className="container mx-auto px-4 flex flex-wrap">
        <div className="process md:w-1/2 w-full md:p-8 py-8 md:sticky md:top-[50px] md:h-screen">
          <div className=" max-w-md  mb-3">
            <h2 className="text-[34px] text-[var(--dgreen)] mb-3 max-w-[300px]">
              Our Approach to <span className="font-bold">Create Value</span>
            </h2>
            
            <p className=" text-md font-normal text-[var(--dgreen)]  mb-3  ">
            ...
            <button className="bg-[#1B3233] text-[#ECF6F2] text-[20px] px-5 py-2 rounded-[40px] w-fit">
              Let’s talk
            </button>
          </div>
        </div>
        ...
        <div className="md:w-1/2 w-full md:p-8 py-8 space-y-6 right-sticky-process text-[#1B3233]">
          <div className="bg-[#d6ebe2] rounded-lg p-8 md:p-16 lg:p-28">
            <h3
              className="text-[60px] md:text-[80px] lg:text-[100px] font-light opacity-30 mb-8 md:mb-12 lg:mb-16"
            >
              1
            </h3>
            <h4
              className="font-normal leading-[120%] text-[20px] md:text-[22px] lg:text-[26px] mb-4 md:mb-6 lg:mb-8"
            >
